//? Async functions are a way to work with asynchronous code in a more synchronous way. They are built on 
// top of promises and are syntactic sugar for promises.
// Example 1 (Uncomment the code below to see the output) You, 15 seconds ago Uncommitted changes
// To understand the async nature of JS, we will use setTimeout function
// setTimeout is a built-in function that is used to lexecute a function after a specified number of milliseconds.
...
const pizzaPromise = () => {
    ...
    // A callback function is a function that is passed as an argument to another function, to be "called back" at a
    //later time.
    ...
    if (order) {
        ...
        setTimeout(() => { // setTimeout is used to simulate a delay 
            ...
            setTimeout(() => { // setTimeout is used to simulate a delay
            reject("After 10 seconds, Pizza not delivered!"); }, 10000);
        }
    });
};
...
pizzaPromise()
    ...
    // Terminology
    // Promise: An object that represents the eventual completion (or failure) of an asynchronous operation and its
    //resulting value.
    ...
    // Callback function: A function that is passed as an argument to another function, to be "called back" at a later 
    //time.
    
    //======================================================================
    // Activity
    // Recode in your IDE and play around with the code. Change the order variable to see the different outputs.
    // Configure git in your project folder and push your code to your repository. Refer to play demogitchange.js for the steps.    